from typing import Sequence, LiteralString, Any, Optional
import numpy as np
# import sys
import itertools
...
rockMatchUps: dict[str, str] = {
    'Win': 'Scissors',
    'Lose': 'Paper',
    'Draw': 'Rock'
}
paperMatchUps: dict[str, str] = {
    'Win': 'Rock',
    'Lose': 'Scissors',
    'Draw': 'Paper'
}
scissorsMatchUps: dict[str, str] = {
    'Win': 'Paper',
    'Lose': 'Rock',
    'Draw': 'Scissors'
}
# region
# rockMatchUps: list[tuple[str, ...]] = [
#     ('Win', 'Scissors'),
#     ('Lose', 'Paper'),
#     ('Draw', 'Rock')
# ]
# paperMatchUps: list[tuple[str, ...]] = [
#     ('Win', 'Rock'),
#     ('Lose', 'Scissors'),
#     ('Draw', 'Paper')
# ]
# scissorsMatchUps: list[tuple[str, ...]] = [
#     ('Win', 'Paper'),
#     ('Lose', 'Rock'),
#     ('Draw', 'Scissors')
# ]
...
def filterAffectedThrows(throw: str) -> None:
    ...
    #     # test for winstay
    #     if Match[y + 1][x] == 'Win' and Match[y + 2][x] == throw:
    #         print(f'win-stay w {throw}')
    #         globals()[f'winStay{throw}Count'] += 1
    #     if Match[y + 1][x] == 'Lose' and Match[y + 2][x] == globals()[f'{throw.lower()}MatchUps']['Lose']:
    #         print('lose-shift w Rock')
    #         globals()[f'loseShift{throw}Count'] += 1
    #     global totalAffectedThrows 
    #     totalAffectedThrows += 1
    # except IndexError:
    #     pass
    # except KeyError:
    #     print(f'{throw} was not found!')
    ...
    try:
        ...
        matchUpDict: dict[str, str] = globals()[f'{throw.lower()}MatchUps']
        if gameResult in validResults:
            print(f'''
{nextThrow}
{matchUpDict}
''')
            nextMatchUpWithCurrent = list(matchUpDict.keys())[list(matchUpDict.values()).index(nextThrow)]
...
# m.matrix = [['Duane', 'Greg', '', '', '', 'Rob "Grappler" Gorey', 'Kristina "Red Rock"'],
    ...
    if prevPlayer == '':
        ...
        while True:
            try: 
                ...
                gamePair: tuple[str, ...] = (m[p1Index, yLevelCount], m[p2Index, yLevelCount])
